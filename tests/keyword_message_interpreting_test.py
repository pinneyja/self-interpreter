...
def test_basic_keyword_message_passing():
	...
	keyword_method_object = RegularObjectNode(code=UnaryMessageNode(None, 'a'))
	keyword_slot = KeywordSlotNode(['x:', 'Y:'], keyword_method_object, ['a', 'b'])
	keyword_container = RegularObjectNode(slot_list=[keyword_slot])
	keyword_message = KeywordMessageNode(keyword_container, ["x:", "Y:"], [IntegerNode(1), RegularObjectNode()])
