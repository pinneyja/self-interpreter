...
\x7fIsComplete: '.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'globals' -> 'modules' -> 'integer' -> () From: ( | {
         ...
         subpartNames <- 'integerIteration
'.
        } | ) 

 bootstrap addSlotsTo: bootstrap stub -> 'traits' -> () From: ( | {
         'Category: core\x7fCategory: numbers\x7fModuleInfo: Module: integer InitialContents: FollowSlot\x7fVisibility: public'
...
'.
 ...
 bootstrap addSlotsTo: bootstrap stub -> 'traits' -> 'integer' -> () From: ( | {
         ...
         shortIfPossibleHexPrintStringPrefix: pre = ( |
            ...
            a <= 9
              ifTrue: [ ^ printString ].
            (< 0 ifTrue: '-' False: ''), pre, a hexPrintString).
        } | ) 
 ...
 bootstrap read: 'integerIteration' From: 'core'
